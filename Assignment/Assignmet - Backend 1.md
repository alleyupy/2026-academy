# Academy Backend - Tugas 1: Frontend

Selamat datang di penugasan frontend pertama untuk para calon backend!

Untuk penugasan kalian, kalian akan diminta untuk membuat **Landing Page** simpel
berikut adalah kriteria yang harus dikerjakan:

- [ ] Memuat file html dan css (js opsional)
- [ ] Memiliki komponen html: `header`, `main`, `footer`, `section`, dan lain-lain
- [ ] Memuat navigasi `nav` (bisa berupa sidebar maupun headerbar), yang bisa merujuk ke section/link yang lain
- [ ] Memuat konten hero (first impression ketika user pertama kali memasuki website)
